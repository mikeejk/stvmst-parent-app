        ...
        <div class="kt-login-v1__wrapper">
            <div class="kt-login-v1__container">
                <h3 class="kt-login-v1__title">
                    Forgot Password!!!. Please Enter Registered Mobile Number.
                </h3>
                ...
                @enderror
                <form action="{{ route('forgot.verify')}}" method="post" class="kt-login-v1__form kt-form" autocomplete="off" id="kt_login_form">
                    @csrf
                    ...
                    <div class="kt-login-v1__actions">
                        <button type="submit" class="btn btn-pill btn-elevate" id="kt_login_submit">Get OTP</button>
                    </div>
                </form>
