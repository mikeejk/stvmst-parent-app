    ...
    <div class="kt-login-v1__body">
        ...
        <div class="kt-login-v1__wrapper">
            <div class="kt-login-v1__container">
                ...
                <form action="{{ route('users.teacher_login')}}" method="post" class="kt-login-v1__form kt-form" autocomplete="off" id="kt_login_form">
                    @csrf
                    <div class="form-group">
                        <input class="form-control" type="text" placeholder="Phone Number" name="teacher_mobile" autocomplete="off">
                    </div>


                    @if ($errors->has('teacher_mobile'))
                    <div class="form-group text-right">
                        <div class=" kt-font-danger kt-font-bolder">{{ $errors->first('teacher_mobile') }}</div>
                    </div>
                    @enderror
